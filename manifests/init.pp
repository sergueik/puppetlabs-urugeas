...
class urugeas(
  # NOTE: expects a value for parameter 'exercise_tomcat_security_change'
  ...
  Variant[String, Undef] $undef_value = undef,
  ...
  Array[String] $package_remove_03 = lookup("${name}::package_remove_02",
       ...
       # NOTE: possible problem with hiera under puppet-rspec:
       # Function lookup() did not find a value for the name 'urugeas::rest_command_payload_fragment'
       # providing dummy default
  String $rest_command_payload_fragment = lookup('urugeas::rest_command_payload_fragment', String, 'first', ''),
  ...
  include stdlib
  # Evaluation Error: Error while evaluating a Resource Statement, Unknown resource type: 'cron'
  # under rspec
  include cron
  ...
  $param1 = hiera('urugeas::param1', undef)
  $param2 = hiera('urugeas::param2', undef)
  $param3 = hiera('urugeas::param3', undef)
